# Pitch - Renovação Sustentável de Frotas de Caminhões
...
### OBS: You need to unzip the 'datasets' file to access the folder containing the 'Oficina.csv' file in order to 
